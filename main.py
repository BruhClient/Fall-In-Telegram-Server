...
def handle_notification(payload: dict) -> None:
    ...
    if not recipient_id or not body:
        return
    asyncio.create_task(forward_notification(recipient_id, body))


async def forward_notification(recipient_id: str, body: str) -> None:
    result = (
    ...
    if not chat_id:
        return
    await _app.bot.send_message(chat_id=chat_id, text=body)
